...
| [`../api/README.md`](../api/README.md) | Contracts and six handlers implemented offline | Strict JSON Schema/OpenAPI contracts, fixtures, lock, operation status and validation workflow. |
...
| [`packaging-and-import.md`](packaging-and-import.md) | M2-07 implemented offline; in review | Explicit bundle commands, strict archive validation, rooted snapshots and opt-in local import. |
