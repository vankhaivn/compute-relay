...
Create `docs/research/kaggle-feasibility.md` before freezing the adapter contract. Every probe should record the question, source/client version, exact test procedure, sanitized result, capability conclusion, and fallback.
