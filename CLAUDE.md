...
and any focused issue/PR evidence linked by the task. Keep full run records private, inspect one
check at a time and preserve failures, original binaries and uncertain remote state. Do not treat
a validation request as authorization for every live effect or change code during a
validation-only run.
